                            ...
                            @can('add privilege')
                                <a class="btn pull-right btn-primary btn-md pull-right"
                                   href="{{ route('admin.roles.create') }}"><i
                                        class="fa fa-plus"></i> Add New Privilege </a>
                            @endcan
                            <h5 style="min-width: 300px;"
                                class="pull-left alert alert-md alert-success">Display All Privileges</h5>
                        </div>
                        <br>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap table-hover " id="example-table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Privilege Name</th>
                ...
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100"
                            style="font-family: 'Cairo'; ">Delete Privilege</h6>
