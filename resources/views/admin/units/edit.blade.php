                ...
                <div class="card-body">
                    <div class="col-12">
                        <a class="btn btn-primary btn-md pull-left" href="{{ route('admin.units.index') }}">عودة
                            للخلف</a>
                        <h5 style="min-width: 300px;" class="pull-right alert alert-md alert-success"> تعديل بيانات
                            الوحدة </h5>
                    </div>
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                          action="{{route('admin.units.update',$unit->id)}}" enctype="multipart/form-data"
                          method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input value="{{$unit->unit_name}}" required class="form-control" name="unit_name"
                                       type="text">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select required name="governorate_id" class="form-control selectpicker show-tick"
                                    ...
                                    @foreach($governorates as $governorate)
                                        <option
                                            @if($unit->governorate_id == $governorate->id)
                                            selected
                                            @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                ...
                                <input value="{{$unit->address}}" required class="form-control" name="address"
                                       type="text">
                            </div>

                            <div class="col-lg-3">
                                <label> السعر <span class="text-danger">*</span></label>
                                <input required value="{{$unit->price}}" class="form-control" name="price"
                                       type="number">
                            </div>
                            ...
                            <div class="col-lg-3">
                                ...
                                <select required name="interval_id" class="form-control selectpicker show-tick"
                                    ...
                                    @foreach($intervals as $interval)
                                        <option
                                            @if($interval->id == $unit->interval_id)
                                            selected
                                            @endif
                            ...
                            <div class="col-lg-3">
                                ...
                                <input required value="{{$unit->count}}" class="form-control" name="count"
                                       type="number">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input value="{{$unit->services}}" type="text" name="services" class="form-control">
                            </div>

                            <div class="col-lg-3">
                                <label> عدد الوحدات المتاحة <span class="text-danger">*</span></label>
                                <input required value="{{$unit->available_number}}" class="form-control"
                                       name="available_number" type="number">
                            </div>
                            <div class="col-lg-3">
                                <label> صور الوحدة <span class="text-danger">*</span></label>
                                <input class="form-control" name="images[]" id="gallery-photo-add" type="file"
                                       multiple>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="gallery">
                                    @foreach($unit->images as $image)
                                        <img style="width:70px;margin:3px;height:70px;border:1px solid #444; border-radius:5px;"
                                             src="{{asset($image->unit_image)}}">
                                    @endforeach
                                </div>
                            </div>
                        </div>
