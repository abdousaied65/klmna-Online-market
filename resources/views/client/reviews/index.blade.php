                                        ...
                                        <div class="card-header pb-0">
                                            <div class="d-flex justify-content-between">
                                                <div class="col-lg-12 margin-tb">
                                                    <h5 class="pull-right alert alert-md alert-success">عرض تقييمات وحداتى</h5>
                                                </div>
                                                <br>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table mg-b-0 text-center table-hover " id="example-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center">وحدة القسم</th>
                                                        <th class="text-center"> عدد التقييمات </th>
                                                        <th class="text-center">متوسط التقييم</th>
                                                        <th class="text-center">عرض كل التقييمات</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    @php
                                                    ...
                                                    @foreach ($reviews as $key => $review)
                                                        <tr>
                                                            ...
                                                            <td>{{ $review->total }}</td>
                                                            <td>{{ round(($review->sum) / ($review->total),2) }}</td>
                                                            <td>
                                                                <a href="{{ route('client.units.reviews.show', $review->unit_id) }}"
                                                                   class="btn btn-md btn-success" data-toggle="tooltip"
                                                                   title="عرض تقييمات هذه الوحدة" data-placement="top"><i class="fa fa-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
