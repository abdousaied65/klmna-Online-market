            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper text-right" dir="rtl">
                        <h2 class="product-title">اعادة تعيين كلمة المرور العملاء والزوار</h2>
                        <ol class="breadcrumb">
                            <li><a href="{{route('index')}}">الرئيسية /</a></li>
                            <li class="current">اعادة تعيين كلمة المرور العملاء والزوار</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <div class="forgot login-area">
                        <h3>
                             اعادة تعيين كلمة المرور العملاء والزوار
                        </h3>
                        @if (session('status'))
                        ...
                        <form role="form" action="{{ route('password.email') }}" method="post" class="login-form">
                            ...
                            <div class="form-group mt-4">
                                <ul class="form-links">
                                    <li class="float-left"><a href="{{route('register')}}">انشاء حساب جديد</a></li>
                                    <li class="float-right"><a href="{{route('login')}}">العودة الى تسجيل الدخول </a></li>
                                </ul>
                            </div>
                        </form>
                    </div>
