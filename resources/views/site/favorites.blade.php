                        ...
                        <div class="sidebar-box">
                            ...
                            <nav class="navdashboard">
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="{{route('my.favorites')}}"><i
                    ...
                    <div class="page-content">
                        <div class="inner-box">
                            <div class="dashboard-box text-center">
                                <h2 class="dashbord-title"> عرض مفضلاتى </h2>
                            </div>
                                                ...
                                                <table dir="rtl" class="table table-bordered table-striped table-hover">
                                                    ...
                                                    @foreach($favorites as $favorite)
                                                        <tr>
                                                            ...
                                                            <td>{{$favorite->unit->client->name}}</td>
                                                            <td>{{$favorite->unit->client->phone_number}}</td>
                                                            <td>
                                                                <a target="_blank" href="{{route('unit.show',$favorite->unit->id)}}" class="btn btn-sm btn-common">
                                                                    عرض الاعلان
                                                                </a>
                                                            </td>
                                                        </tr>
